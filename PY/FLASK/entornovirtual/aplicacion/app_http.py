...
def inicio():
	...
	cad += "header:\n"
	for item, value in request.headers.items(): # headers es un diccionario
		cad += "{}:{}".format(item, value)
...
# curl http://localhost:5000/info?id=10
# curl -X POST http://localhost:5000/info -d id=55
