...
def saluda(nombre=None):
	return render_template("tempboot1.html", nombre=nombre)
...
def suma(num1, num2):
	try:
		...
		abort(404)
	return render_template("tempboot2.html", num1=num1, num2=num2, resultado=resultado)
...
def tabla(numero):
	try:
		...
		abort(404)
	return render_template("tempboot3.html", num=numero)
...
def enlaces():
	...
	return render_template("tempboot4.html", enlaces=enlaces)
