...
boton8 = Button(miFrame, text="8", width=3, command=lambda:numeroPulsado("7"))
boton8.grid(row=2, column=2)
boton9 = Button(miFrame, text="9", width=3, command=lambda:numeroPulsado("7"))
boton9.grid(row=2, column=3)
botonDiv = Button(miFrame, text="/", width=3, command=lambda:numeroPulsado("7"))
